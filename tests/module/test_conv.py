...
class TestConv(TestModule.Inner, unittest.TestCase):
    ...
    def setUp(self):
        self.module = nn.Conv2d(3, 3, 3, bias=True, groups=3)
        self.torch_module = torchnn.Conv2d(3, 3, 3, bias=True, groups=3)
        self.weights = {
        ...
        self.module_input = np.random.normal(size=(2, 3, 4, 4)).astype("float32")
