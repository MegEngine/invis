...
if __name__ == "__main__":
    from shufflenet import shufflenet_v2_x1_0 as shufflenet
    from shufflenet_invis import shufflenet_v2_x1_0 as mge_shufflenet

    model = shufflenet(pretrained=True)
    model.eval()
    mge_model = mge_shufflenet(pretrained=True)
    mge_model.eval()
